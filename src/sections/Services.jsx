...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      icon: (
        <div className="w-14 h-14 bg-purple-100 rounded-lg flex items-center justify-center mb-6">
          <i className="fas fa-paint-brush text-purple-600 text-2xl"></i>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="w-14 h-14 bg-pink-100 rounded-lg flex items-center justify-center mb-6">
          <i className="fas fa-mobile-alt text-pink-600 text-2xl"></i>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="w-14 h-14 bg-indigo-100 rounded-lg flex items-center justify-center mb-6">
          <i className="fas fa-search-dollar text-indigo-600 text-2xl"></i>
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      description:
        "Comprehensive strategies to grow your online presence and customer base.",
      button: {
        text: "Learn more",
  ...
  return (
    <SectionLayout
      title="Services"
      id="services"
      description="I offer a range of services to help your business succeed in the digital space."
      bg="gray">
